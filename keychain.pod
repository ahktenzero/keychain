...
S<[ --stop I<which> ] [ --timeout I<minutes> ] [ --wipe I<which> ]
S<[ --force-pidfile ] [ keys... ]>
...
it cannot be relied on to be available persistently. This can be overridden by the B<--force-pidfile> option.
